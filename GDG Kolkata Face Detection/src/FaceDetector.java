...
//System.out.print(FaceDetector.class.getResource(image1.getAbsolutePath()));
 ...
 int j=0;
        ...
        //    Mat imgMat = Highgui.imread(FaceDetector.class.getResource("Pics/ouput"+i+".png").getPath().substring(1), Highgui.CV_LOAD_IMAGE_GRAYSCALE);
